...
ggplot(data = evals,
  ...
  labs(
    x = "score",
    y = "count",
    title = "score in evals")
```

As the score increases the count increases.
...
ggplot(data = evals,
  ...
  labs(
    x = "score",
    y = "bty_avg",
    title = "relationship between score and bty_avg in evals")
```

The data is spread in lines. 
...
There is a gentle increasing slope in the data, which the decreases and then increases stredily in s straight line. 
...
r squared is 3.35% of the score_bty_fit data. 
